...
urlpatterns = [
    ...
    url(r'^property/search/$', views.SearchResultApiView.as_view(), name="retrieve-top-property"),
    url(r'^property/search_suggestions/$', views.SearchSuggestionsApiView.as_view(), name="retrieve-top-property"),
