    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landmark', models.ManyToManyField(blank=True, to='buyproperty.Landmark')),
                ('media', models.ManyToManyField(blank=True, to='buyproperty.Media')),
                ('nearest', models.ManyToManyField(blank=True, to='buyproperty.Nearest')),
                ('other_charges', models.ManyToManyField(blank=True, to='buyproperty.OtherCharges')),
                ('overlooking', models.ManyToManyField(blank=True, to='buyproperty.Overlooking')),
            ],
        ),
        migrations.AddField(
            model_name='customerlead',
            name='for_property',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='buyproperty.Property'),
        ),
    ]
